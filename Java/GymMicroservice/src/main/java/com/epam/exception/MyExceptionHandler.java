...
public class MyExceptionHandler {
	...
	@ResponseStatus(code = HttpStatus.NOT_FOUND)
	public ExceptionResponse handleTraineeException(TraineeException e,WebRequest w)
	{
		log.info("TraineeException Occured : {}",e);
		return new ExceptionResponse(new Date().toString(),e.getMessage(),HttpStatus.NOT_FOUND.toString(),w.getDescription(false));
	}

	@ExceptionHandler(TrainerException.class)
	@ResponseStatus(code = HttpStatus.NOT_FOUND)
	public ExceptionResponse handleTrainerException(TrainerException e,WebRequest w)
	{
		log.info("TrainerException Occured : {}",e);
		return new ExceptionResponse(new Date().toString(),e.getMessage(),HttpStatus.NOT_FOUND.toString(),w.getDescription(false));
	}
